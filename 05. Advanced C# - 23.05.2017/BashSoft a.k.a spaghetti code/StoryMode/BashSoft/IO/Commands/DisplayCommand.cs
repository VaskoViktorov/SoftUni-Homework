...
namespace BashSoft.IO.Commands
{
    ...
    public class DisplayCommand : Command
    {
        ...
        private IComparer<IStudent> CreateStudentComparator(string sortType)
        {
            ...
            {
                return Comparer<IStudent>.Create((studemtOne, studentTwo) => studemtOne.CompareTo(studentTwo));
            }

            if (sortType.Equals("descending", StringComparison.OrdinalIgnoreCase))
            {
                return Comparer<IStudent>.Create((studemtOne, studentTwo) => studentTwo.CompareTo(studemtOne));
            }
